            ...
            <div class="col-md-6">
                <div class="form-panel">
                    ...
                    <div class="form-group">
                      <img src="D:\laragon\www\Info-Sport\public\assets\img\ui-zac.jpg" style="width:20%">
                      <h1 style="text-align:center">{{ $center->name_center }}</h1>
                      <p class="title" style="text-align:center">{{ $center->address }}&nbsp;&nbsp;<i class="fa fa-dribbble" ></i></p>
                      ...
                      <p><button><a id="edit" href="{{ route('center.edit') }}">Editar datos</a></button></p>
                    </div>
                </div>
            </div>
        @endforeach
                ...
                <div id="home" class="tab-pane in active">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 center">
                            ...
                            <a href="{{ route('center.edit',$center->id) }}" class="btn btn-sm btn-block btn-success">
