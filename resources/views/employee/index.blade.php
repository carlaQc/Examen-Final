...
@include('layouts.newnotification')
    <h3><i class="fa fa-angle-right"></i> <strong>Empleados</strong> </h3>
    <div>
        Lista de Empleados
        <a style="margin-bottom: 20px;float: right;" href="{{ route('employee.create') }}">
                    ...
                    <tbody>
                        @foreach($users as $user)
                            <tr>
                                ...
                                @endif
                                <td style="vertical-align: inherit;" class="text-center">
                                    <a id="edit" href="{{ route('employee.edit',Crypt::encrypt($user->id)) }}">
