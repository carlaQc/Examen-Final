...
<h3><i class="fa fa-angle-right"></i> <strong>Empleado</strong> </h3>
<div style="margin-bottom: 10px;">
    <a href="{{ route('employee.get') }}" style="color:gray; text-decoration: none;">
       Lista de empleados
    </a> /
    <strong>Actualizar datos de empleado</strong>
</div><br>

<div class="row">
    <div class="col-lg-12">
        <div class="form-panel">
            <form data-parsley-validate class="form-horizontal style-form formi" action="{{ route('employee.update',Crypt::encrypt($user->id)) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="form">
                  <div class="col-lg-offset-10">
                    ...
                    <a style="color:black;" href="{{ route('employee.get') }}">
