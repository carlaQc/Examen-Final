...
<div class="row">
    <div class="col-lg-12">
        <div class="form-panel">
            <form data-parsley-validate class="form-horizontal style-form formi" action="{{ route('user.store',$center) }}" method="POST">
            @csrf
                ...
                <div class="form">
                    <div class="col-lg-offset-10">
                        <button id="saveAdmin" type="submit" class="btn btn-primary btn-md btn-block">Guardar Datos</button>
                    </div>
                </div>
